...
public class CopyOfGeneratorTest {
	 ...
	 */
	@Test
	public void encryptDecryptPasswordTest() throws NoSuchAlgorithmException,
		...
		OldImixsKeyGenerator.generateSecureKeyPair(PRIVATE_KEY_FILE,
				PUBLIC_KEY_FILE, ALGORITHM, password);
	...
	@Test
	public void SpezialTest() throws Exception {

		String password = "adminadmin";

		ImixsSecretKeyGenerator.generateKeyPair(PRIVATE_KEY_FILE,
				PUBLIC_KEY_FILE, ALGORITHM, password);

		// publicKey = ImixsKeyGenerator.getPublicKey(PUBLIC_KEY_FILE);
		// privateKey = ImixsKeyGenerator.getPrivatKey(PRIVATE_KEY_FILE);

		ImixsSecretKeyGenerator.encrypt(PUBLIC_KEY_FILE,
				"src/test/resources/schmarrn");
		ImixsSecretKeyGenerator.decrypt(PRIVATE_KEY_FILE, password,
				"src/test/resources/schmarrn.encrypted");

	}

	@Test
	public void SpezialTest2() throws Exception {

		String password = "kingralph";

		ImixsSecretKeyGenerator.encrypt("src/test/resources/id_rsa.pub",
				"src/test/resources/schmarrn");
		ImixsSecretKeyGenerator.decrypt("src/test/resources/id_rsa", password,
				"src/test/resources/schmarrn.encrypted");

	}

	@Test
	public void testBouncy1() throws Exception {
